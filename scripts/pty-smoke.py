...
def fixture(home):
    ...
    inventory = dict(version=1, observedAt="2026-01-01T00:00:00Z",
                     ...
                     skillUsage=dict(version=2, sessions=[dict(name="alpha-review", harness="codex", sessionId="b" * 64, pathId="a" * 64, firstUsedAt="2026-01-01T00:00:00Z", lastUsedAt="2026-01-01T00:00:00Z", eventCount=2)], backfill=dict(complete=True, filesDiscovered=1, filesPending=0), history=[dict(id="d" * 64, name="alpha-review", pathId="a" * 64, harness="codex", evidence="read", at="2026-01-01T00:00:00Z")], usage=[dict(name="alpha-review", pathId="a" * 64, harness="codex", evidence="read", count=2, lastUsedAt="2026-01-01T00:00:00Z")],
