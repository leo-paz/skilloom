...
Rows focus on the skill name, ownership, and machine count. Narrow terminals prioritize the skill name. Invocation and read evidence live in the full details view opened with Enter or `i`.
