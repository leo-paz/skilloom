...
- 03ded3f: Process historical logs without a default overall deadline, stream large records, and preserve distinct session totals independently of the recent-event display cache.
- bdbeb10: Publish the first stable Skilloom CLI with automated canary and production releases.
- 03ded3f: Add optional collapsible source grouping to the Library, preserving search, machine filters, and source-specific skill details.
...
- 03ded3f: Lead skill details with recorded recency and keep reader errors and collection diagnostics behind an explicit toggle.
